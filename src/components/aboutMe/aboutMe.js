      ...
      <div className="aboutMeInfo">
        ...
        <div className="aboutMeText">
          <p className="alignLeft">
            ...
            a passion for it. I first started properly coding in school where I
            was taught to code in <i>Delphi</i>, a language derived from pascal.
            I really enjoyed coding but like many, I had the misconception that
          ...
          <p className="alignRight">
            ...
            soon, however, hit a big roadblock, I needed to create a website
            that would automate certain jobs like connecting a company with a
            student. So I took a big risk and moved from South Africa to Paris
            where I took part in a month long Bootcamp at a school called{" "}
            <a
          ...
          <p className="alignLeft">
            ...
            realised that working in tech is what I wanted to do. We learnt to
            code functions in C++. I got to a point where I was experimenting
            with solving problems using backtracking.
          </p>
          <p className="alignRight">
            After this course, I moved to London with the goal of doing another
            Bootcamp so I could become a web-developer. While I was settling
            down in London, I worked for a tech company,{" "}
            <a href="https://pynk.io" target="_blank" rel="noopener noreferrer">
              Pynk
            </a>
            , running a podcast on new technologies and startups.
          </p>
          <p className="alignLeft">
            I started a software-engineering course at{" "}
            <a
            ...
            <i>Rails</i>, <i>Javascript</i>, <i>React</i> and <i>Redux</i>. I
            have really enjoyed the course and it has really solidified my
            passion for coding.
          </p>
          <p className="alignRight">
